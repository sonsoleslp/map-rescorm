...
export default class Shape extends React.Component {
  ...
  render(){
    let {text, path} = this.state;
      ...
      let strokeWidth = this.props.data.strokeWidth;
    return (<Set>
      <Path click={()=>{this.props.click(this.props.data.name);}} d={path} load={this.handleLoad.bind(this)} attr={{fill:color.fill, stroke:color.stroke, 'stroke-width': strokeWidth}} mouseover={mouseover}  mouseout={function(){mouseout(this,color.fill)}}/>
